...
# admnistration des droits : sudo chmod 777 /etc/cups/ppd/*
...
# faire une copie du ppd en ppd_save
# modifier le fichier ppd_save (remplacement de *DefaulUserCode: None par *DefaultUserCode: 0000)
...
def modifFichierPPD(usercode):
    ...
    fsave = "/etc/cups/ppd/RICOH_SDP.ppd_save"
    fppd = "/etc/cups/ppd/RICOH_SDP.ppd"
...
Label1 = Label(
    fenetreDialogue,
    text="Saisir votre code et valider en appuyant sur la touche Entrée",
).grid(row=0, columnspan=2, padx=30, pady=10)
